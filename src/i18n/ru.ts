export const ru: Record<string, string> = {
  ...
  'Background image search failed': 'Не удалось найти изображения',
  Blur: 'Размытие',
  Border: 'Граница',
  Cancel: 'Отмена',
  ...
  'Could not use this image': 'Не удалось установить изображение',
  'Could not open source page': 'Не удалось открыть страницу источника',
  Danger: 'Опасный',
  ...
  'Discord lyric merge gap': 'Интервал сшивания строк Discord',
  errors: 'ошибок',
  ...
  General: 'Общие',
  'Language, launch and app behavior.': 'Язык, запуск и поведение приложения.',
  'Theme, typography and listening visuals.': 'Тема, шрифт и визуальные эффекты.',
  ...
  'Last 12 months': 'За 12 месяцев',
  'Library views': 'Фильтр медиатеки',
  'Search in library': 'Найти в медиатеке',
  'All tracks': 'Все треки',
  'Never played': 'Не прослушивали',
  'No tracks found': 'Треки не найдены',
  'No tracks match this filter': 'Нет треков по этому фильтру',
  'No unplayed tracks in this part of the library': 'В этой части медиатеки нет непрослушанных треков',
  Duration: 'Длительность',
  Tracklist: 'Треклист',
  'Playlist cover': 'Обложка плейлиста',
  'active days': 'дней с прослушиваниями',
  'Less to more listening': 'От меньшей активности к большей',
  'Your collection': 'Ваша коллекция',
  'Good afternoon': 'Добрый день',
  'Good evening': 'Добрый вечер',
  'Good morning': 'Доброе утро',
  Home: 'Главная',
  'Gradient palette': 'Градиентная палитра',
  ...
  'No background images found': 'Изображения не найдены',
  ...
  'Playlists that sound like you': 'Плейлисты под ваше настроение',
  ...
  'Search artists': 'Найти исполнителя',
  'Search albums': 'Найти альбом',
  'Search playlists': 'Найти плейлист',
  'No artists match': 'Исполнители не найдены',
  'No albums match': 'Альбомы не найдены',
  'No playlists match': 'Плейлисты не найдены',
  'Other artists': 'Остальные исполнители',
  ...
  'Search backgrounds': 'Поиск фонов',
  'Search for a background': 'Введите запрос для поиска фона',
  'Search for background images': 'Поиск фоновых изображений',
  'Search images': 'Найти изображения',
  'Minimum resolution': 'Минимальное разрешение',
  ...
  'Saving image…': 'Сохраняю изображение…',
  ...
  'Add at least one lyric line': 'Добавьте хотя бы одну строку',
  'Add lyric line': 'Добавить строку',
  ...
  'Fix the invalid lyric line': 'Исправьте строку с ошибкой',
  'Line ends after the track ends': 'Строка заканчивается позже трека',
  'Line starts after the track ends': 'Строка начинается позже конца трека',
  'Lyric line': 'Текст строки',
  'Lyrics editor': 'Редактор текста песни',
  'Lyrics format': 'Формат текста',
  'Lyrics published to LRCLIB': 'Текст отправлен в LRCLIB',
  'More actions': 'Дополнительные действия',
  'Plain text': 'Обычный текст',
  'Publish to LRCLIB': 'Отправить в LRCLIB',
  'Remove lyric line': 'Удалить строку',
  'Sort lines by start time': 'Отсортируйте строки по времени начала',
  'Start time': 'Начало',
  'Synced lyrics': 'Синхронизированный текст',
  'Track duration must be between 1 and 3600 seconds to publish': 'Для публикации длительность трека должна быть от 1 до 3600 секунд',
  'Track title and artist are required to publish lyrics': 'Для публикации нужны название трека и исполнитель',
  Hide: 'Скрыть',
  Title: 'Название',
  Likes: 'Лайки',
  'Sort by': 'Сортировка',
  ...
  'Listening activity': 'Активность прослушивания',
  ...
  'Choose a mix': 'Выберите подборку',
  'Previous mix': 'Предыдущая подборка',
  'Next mix': 'Следующая подборка',
  'Show mix': 'Показать подборку',
  'Listened recently': 'Слушали недавно',
  ...
  'Sort by year': 'По году',
  'Recently updated': 'Недавно изменённые',
  'Most tracks': 'Больше треков',
  Pinned: 'Закреплён',
  ...
  'Delete saved preset': 'Удалить сохранённый пресет',
  ...
  'Looking for songs, not videos…': 'Ищу песни, а не видео…',
  'Reading what came back…': 'Разбираю, что вернулось…',
  'Asking YouTube Music…': 'Спрашиваю YouTube Music…',
  'Opening each album…': 'Открываю альбомы по одному…',
  ...
  'Copy from library': 'Из медиатеки',
  'Remove cover': 'Убрать обложку',
  'Search library': 'Поиск в медиатеке',
  ...
  Year: 'Год',
  Genre: 'Жанр',
  'No artwork found': 'Обложка не найдена',
  'Title is required': 'Укажите название',
  'Enter valid track, disc and year values': 'Проверьте номера трека и диска и год',

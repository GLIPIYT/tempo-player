...
| **Музыка всегда под рукой** | Ищите SoundCloud и YouTube Music рядом с локальной коллекцией. Собирайте очередь, включайте шаффл и повтор, настраивайте кроссфейд и громкость, меняйте скорость воспроизведения, регулируйте локальные и кэшированные треки десятиполосным эквалайзером, выбирайте волну или спектр. |
...
Tempo находится в альфа-версии (`0.9.0`) и в первую очередь ориентирован на Windows. Сейчас релизный workflow публикует установщик Windows. Сетевое подключение нужно онлайн-функциям и обновлятору; локальная библиотека не требует аккаунта или облачного сервиса.

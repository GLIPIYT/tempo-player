...
/// on `ytdlp://enriched`, because resolving a track takes about a second and a
/// half and waiting for the batch would leave the list blank for half a minute.
#[tauri::command]
...
#[tauri::command]
pub async fn ytdlp_enrich_cancel(job_id: String) {
